from crossovers import crossover_rbx, crossover_uox, crossover_cx, crossover_pmx
from selections import selection_tournament_deterministic
from mutations import mutation_insertion, mutation_inversion, mutation_scramble
...
vehicles_count_over_deport_hours_preference = 10000
...
population = {
    'pop_size': 150,
    'crossover_method': staticmethod(crossover_rbx), # Pas de crossover_ratio. Tous les parents sélectionnés sont systématiquement croisés.
    'mutation_method': staticmethod(mutation_insertion),
    ...
    # plot
    'plot_x_div': 10, # Contrôle la fréquence de mise à jour du graphique (Comme report est appelé tous les gen_index_div = 50 générations, la mise à jour réelle se fait tous les 50 × 100 = 5000 générations.)
